...
$this->redirect('indexExpose');
    ...
    public function addAudit() {
        ...
        if ($this->request->is(array('post', 'put'))) {
            ...
            if($this->Letter->Activity->Evidence->createZip($this->Letter->Activity->getInsertID())) return $this->redirect(array('action' => 'addAuditSuccess', $this->Letter->Activity->Evidence->getInsertID()));
