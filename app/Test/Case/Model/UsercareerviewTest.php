<?php
App::uses('Usercareerview', 'Model');

/**
 * Usercareerview Test Case
 *
 */
class UsercareerviewTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Usercareerview = ClassRegistry::init('Usercareerview');
	}
